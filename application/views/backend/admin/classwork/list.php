    ...
    <table class="table table-bordered table-responsive-sm" width="100%">
        ...
        <?php foreach($marks as $mark):
                ...
                <tr>
                    ...
                    <td class="text-center"><button class="btn btn-success" onclick="classwork_update('<?php echo $mark['student_id']; ?>')"><i class="mdi mdi-checkbox-marked-circle"></i></button></td>
                </tr>
        <?php endforeach; ?>
        </tbody>
    </table>
