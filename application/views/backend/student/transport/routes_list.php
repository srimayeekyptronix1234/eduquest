<?php
    ...
    $check_data = $this->db->get_where('assignroutes',['user_id'=>$student_data['user_id']])->result_array();
          ...
          <td>
            ...
            <div class="dropdown text-center">
              ...
              <div class="dropdown-menu dropdown-menu-end">
                <!-- item-->
                <a href="javascript:void(0);" class="dropdown-item" onclick="rightModal('<?php echo site_url('modal/popup/transport/routes_edit/'.$data['id'])?>', '<?php echo get_phrase('update_assign_route'); ?>');"><?php echo get_phrase('edit'); ?></a>
                <!-- item-->
